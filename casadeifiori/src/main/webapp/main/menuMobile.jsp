...
<div id="menuDropBar" class="menuDrop sidenav">
	...
	<button class="dropdown-btn">
		Il mio profilo <i class="fa fa-caret-down"></i>
	</button>
	<% 
  	boolean isAdmin2;
	...
	<div class="dropdown-container">
		<a href="user.jsp">Il mio account</a> <a href="cartPage.jsp">carrello</a>
		<a href="MostraOrdiniEffettuati">I miei Ordini</a> <a
			href="EffettuaLogOut">Log-out</a>
	</div>
	<% }else{%>
	<div class="dropdown-container">
		<a onclick="openLogIn()">Accedi</a> <a onclick="openSignIn()">Iscriviti</a>
		<a href="cartPage.jsp">carrello</a>
	</div>
	<% }if(isAdmin2){%>
	<button class="dropdown-btn">
		Amministrazione <i class="fa fa-caret-down"></i>
	</button>
	<div class="dropdown-container">
		<a href="adminMostraOrdini">Amministrazione Ordini</a> <a
			href="addItemPage.jsp">Aggiungi prodotto</a>
	</div>
	<% } %>
	<button class="dropdown-btn">
