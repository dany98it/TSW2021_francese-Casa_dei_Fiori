				...
				<form action="AggiungiIndirizzo" method="post" >
					<div class="txtFieldAddAddress txtFieldAddAddress--2">
						<label class="AddressLabel" for="nome">
							...
							<input class="AddressInput" type="text" id="nomeIndirizzo" name="nome" required="required" placeholder="MARIO"/>
						</label>
					
						<label class="AddressLabel" for="Cognome">
							<span class="AddressLabelSpan" >Cognome</span>
							<input class="AddressInput" type="text" id="cognomeIndirizzo" name="Cognome" required="required" placeholder="ROSSI"/>
						</label>
					</div>
					...
					<div class="txtFieldAddAddress">
						<label class="AddressLabel" for="via">
							...
							<input class="AddressInput" type="text" id="viaIndirizzo" name="via" required="required" placeholder="via/corso/viale Roma"/>
						</label>
					</div>
					<div class="txtFieldAddAddress txtFieldAddAddress--3">
						<label class="AddressLabel" for="CAP">
							<span class="AddressLabelSpan" >CAP</span>
							<input class="AddressInput" type="text" id="CAPIndirizzo" name="CAP" required="required" placeholder="80000"/>
						</label>
	
						<label class="AddressLabel" for="interno">
							<span class="AddressLabelSpan" >Interno</span>
							<input class="AddressInput" type="text" id="internoIndirizzo" name="interno" value="0" placeholder="3"/>
						</label>
						<label class="AddressLabel" for="numeroCivico">
							<span class="AddressLabelSpan" >Numero Civico</span>
							<input class="AddressInput" type="text" id="numeroCivicoIndirizzo" name="numeroCivico" required="required" placeholder="189"/>
						</label>
					</div>
